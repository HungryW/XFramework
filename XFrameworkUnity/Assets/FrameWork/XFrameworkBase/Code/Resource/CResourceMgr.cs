...
namespace XFrameworkBase
{
    public partial class CResourceMgr : CGameframeworkMoudle
    {
        ...
        private CReadWriteVersionListChecker m_ReadWriteVersionListChecker;
        ...
        public CResourceMgr()
        {
            ...
            m_ReadWriteVersionListChecker = new CReadWriteVersionListChecker(this);
        ...
        public override void Update(float a_fElapseSed, float a_fRealElapseSed)
        {
            ...
            m_ReadWriteVersionListChecker.Update(a_fElapseSed, a_fRealElapseSed);
        }
