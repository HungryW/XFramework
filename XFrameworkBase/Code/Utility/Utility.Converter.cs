    ...
    public static partial class Utility
    {
        ...
        public static class Converter
        {
            ...
            public static void GetBytes(bool value, byte[] buffer, int startIndex)
            {
                ...
                Debug.Assert(startIndex >= 0 && startIndex + 1 <= buffer.Length);
            ...
            {
                Debug.Assert(buffer != null);
                Debug.Assert(startIndex >= 0 && startIndex + 2 <= buffer.Length);
            ...
            {
                Debug.Assert(buffer != null);
                Debug.Assert(startIndex >= 0 && startIndex + 4 <= buffer.Length);
            ...
            {
                Debug.Assert(buffer != null);
                Debug.Assert(startIndex >= 0 && startIndex + 8 <= buffer.Length);
            ...
            public static string ToHexStrFromByte(byte[] byteDatas)
            {
                ...
                {
                    builder.Append(Text.Format("{0:X2}", byteDatas[i]));
                }
